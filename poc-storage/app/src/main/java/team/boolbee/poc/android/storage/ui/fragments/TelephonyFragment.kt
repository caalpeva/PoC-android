 ...
 * [TelephonyFragment.OnListFragmentInteractionListener] interface.
 */
class TelephonyFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Toast.makeText(context, "HOLAAAA", Toast.LENGTH_LONG).show()
    }
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = CellDataRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
